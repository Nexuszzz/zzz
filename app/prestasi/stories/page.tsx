...
import { BookHeart, ArrowLeft, Star, Calendar } from 'lucide-react';

export const metadata: Metadata = {
    title: 'Success Stories | APM Polinema',
    description: 'Kisah inspiratif perjalanan meraih prestasi',
};
            ...
            <section className="bg-gradient-to-br from-accent via-accent to-accent-hover text-white">
                <div className="container-apm py-12">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold font-heading">Success Stories</h1>
                            <p className="text-white/80 mt-1">Kisah inspiratif perjalanan meraih prestasi</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-white rounded-2xl border border-gray-100 p-8 lg:p-12 text-center shadow-sm mb-8">
                            ...
                            <h2 className="text-2xl lg:text-3xl font-bold text-text-main mb-4">
                                Success Stories Sedang Dikembangkan
                            </h2>
                            
                            <p className="text-text-muted text-lg mb-6 max-w-2xl mx-auto">
                                Fitur success stories masih dalam tahap pengembangan. Fitur ini akan berisi artikel mendalam tentang perjalanan mahasiswa meraih prestasi, tips, dan insight berharga.
                            </p>
